...
- Rig development and skinning in Maya, shader creation, and asset optimization.
- Rendering and memory optimization against the open-world streaming budget.
- In-engine cloth and rigid-body physics setup.
- Defined the art workflow and asset pipeline.